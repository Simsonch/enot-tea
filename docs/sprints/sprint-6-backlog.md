...
- [x] P0 завершен (S6-001...S6-006, проверено 2026-04-28).
- [x] P1 завершен (S6-007, S6-008).
- [x] S6-009 закрыт в docs-only формате: ручной smoke зафиксирован в runbook/test-strategy, e2e-job отложен на следующий этап.

## Ворота релиза: выход из спринта 6

- [x] Ручной happy path задокументирован (`docs/runbooks/local-dev-storefront-admin.md`, smoke пройден 2026-04-28).
- [x] Сборка storefront без ошибок (`pnpm ci:verify`, 2026-04-28).
- [x] Все P0 в backlog закрыты или явно отложены с причиной.
